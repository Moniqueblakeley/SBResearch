...
$search["actions"] = '<input id="search-submit-topbar" rel="tooltip" data-placement="bottom" data-original-title="' . t('Click to search') . '" type="image" src="' .  base_path() . path_to_theme() . '/img/search-icon.png"  border="0" a="" />';
