        ...
        function checkPlaylistProcess() {
            ...
            if(processPlaylistCounter < processPlaylistLength){
                ...
                if(!_componentInited){
                    ...
                    if(playlistType!='wall'){
                        if(autoHideControls){
                            big_play.bind('mouseenter', overComponent).bind('mouseleave', outComponent);
                            playerControls.bind('mouseenter', overComponent);
                            $(".playlistHolder li").bind('mouseenter', outComponent);
                        }else{
                            showControls();
                        }
                    }
