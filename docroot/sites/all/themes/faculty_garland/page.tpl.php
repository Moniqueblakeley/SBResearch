...
drupal_add_js(drupal_get_path('theme', 'faculty_garland').'/FacultyPages.js');


drupal_add_js(drupal_get_path('theme', 'faculty_garland').'/jquery.touchSwipe.js');
drupal_add_js(drupal_get_path('theme', 'faculty_garland').'/jquery.touchSwipe.min.js');
...
-->
 <header>
        <div id="StonyBrookUniversityLogo">
            <img id="SbuLogo" alt="Stony Brook University" src="/sites/all/themes/faculty_garland/images/FacultyProfiles-Logo.png" />
        </div>
