...
$art_style = '';
$art_head = '';
function artisteer1_process_html(&$variables) {
...
function artisteer1_breadcrumb($variables) {
 ...
 * @ingroup themeable
 */
function artisteer1_button($variables) {
 ...
 */
function artisteer1_preprocess_page(&$vars) {
  global $art_style, $art_head;
 ...
 * @ingroup themeable
 */
function artisteer1_menu_local_task($variables) {
 ...
 */
function artisteer1_feed_icon($variables) {
 ...
 * @ingroup themeable
 */
function artisteer1_node_preview($variables) {
  $node = $variables['node'];
...
*/
function artisteer1_form_alter(&$form, &$form_state, $form_id) {
...
function artisteer1_form_element_label($variables) {
...
function artisteer1_form_element($variables) {
  $element = &$variables['element'];
  // This is also used in the installer, pre-database setup.
  $t = get_t();
...
function artisteer1_pager($variables) {
  $tags = $variables['tags'];
  $element = $variables['element'];
